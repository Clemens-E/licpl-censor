...
parser.add_argument(
    ...
    type=int,
    help=
    "number of frames to process in one batch, keep it at default unless you tested performance",
    default=1)

parser.add_argument("--no-blur",
                    help="do not blur, instead add annotations",
                    action="store_true")

parser.add_argument("--model",
                    help="model to use for detections",
                    default="best.pt")

parser.add_argument(
    "--multi",
    help=
    "use experimental multiprocessing, most likely will not improve performance",
    default=False)
...
parser.add_argument("--flat-output",
